...
REMOTE_PROJECT_DIR="/opt/simple-smtpd"
...
- name: Collect packages from remote VMs
  ...
  vars:
    ...
    remote_dist_dir: "/opt/simple-smtpd/dist"
    remote_build_dir: "/opt/simple-smtpd/build"
    remote_centralized_dir: "/opt/simple-smtpd/dist/centralized/v$VERSION"
